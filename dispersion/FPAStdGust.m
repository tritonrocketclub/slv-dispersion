function [gammaG] = FPAStdGust(rho,S,L,Cla,Cma,sigmaG,lg,m,a,g,Ip,d,h)
% Objective: This function computes the standard deviation in one component
% of the flight path angle due to turbulence (wind gusts)
%
