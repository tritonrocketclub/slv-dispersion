%Clear the workspace of variables and figures
clear all; close all; clc;

%Create altitude vector
h=[0:500:100000];%altitude [m]
...
gamma_G = std_dev_gust_component(rho_burnout, S, L, C_L_alpha, C_M_alpha, sigma_G, l_G, m_b, a, g, I_p, d, h_burnout); %Standard deviation in flight path angle due to gust [rad]
